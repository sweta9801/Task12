            ...
            <nav className='navbar'>
                <div className='navbar__top'>
                    <div className='navbar__top__logo'>
                        <Link className='navbar__top__logo__link' to='/'>Project</Link>
                    </div>
                ...
                <div className='navbar__bottom'>
                    ...
                    <li className='navbar__bottom__item'>
                        <NavLink className='navbar__bottom__item__link' exact to='/client_details'>Client Details</NavLink>
                    </li>
                    <li className='navbar__bottom__item'>
                        <NavLink className='navbar__bottom__item__link' exact to='/tradies_list'>Tradies List</NavLink>
                    </li>
                </div>
            </nav>
            <Alert />
